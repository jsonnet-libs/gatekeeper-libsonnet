---
permalink: /3.12/expansion/v1alpha1/expansionTemplate/
---

# expansion.v1alpha1.expansionTemplate
...
* [`obj spec`](#obj-spec)
  ...
  * [`fn withEnforcementAction(enforcementAction)`](#fn-specwithenforcementaction)
  * [`fn withTemplateSource(templateSource)`](#fn-specwithtemplatesource)
  ...
  * [`obj spec.generatedGVK`](#obj-specgeneratedgvk)
    * [`fn withGroup(group)`](#fn-specgeneratedgvkwithgroup)
    * [`fn withKind(kind)`](#fn-specgeneratedgvkwithkind)
    * [`fn withVersion(version)`](#fn-specgeneratedgvkwithversion)
...
new returns an instance of ExpansionTemplate
...
### fn spec.withEnforcementAction

```ts
withEnforcementAction(enforcementAction)
```
...
### fn spec.withTemplateSource

```ts
withTemplateSource(templateSource)
```
...
### fn spec.generatedGVK.withVersion
