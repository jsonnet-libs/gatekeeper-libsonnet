---
permalink: /3.12/mutations/v1alpha1/assignImage/
---

# mutations.v1alpha1.assignImage
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.parameters`](#obj-specparameters)
    * [`fn withAssignDomain(assignDomain)`](#fn-specparameterswithassigndomain)
    * [`fn withAssignPath(assignPath)`](#fn-specparameterswithassignpath)
    * [`fn withAssignTag(assignTag)`](#fn-specparameterswithassigntag)
...
new returns an instance of AssignImage
...
### fn spec.parameters.withAssignDomain

```ts
withAssignDomain(assignDomain)
```

"AssignDomain sets the domain component on an image string. The trailing slash should not be included."

### fn spec.parameters.withAssignPath

```ts
withAssignPath(assignPath)
```

"AssignPath sets the domain component on an image string."

### fn spec.parameters.withAssignTag

```ts
withAssignTag(assignTag)
```
